...
INSERT INTO `schedules` VALUES (1,1,1,3),(2,1,1,4),(3,1,1,5),(4,1,2,1),(5,1,2,5),(6,1,2,6),(7,1,3,1),(8,1,3,2),(9,1,3,3),(10,2,2,2),(11,2,2,4),(12,2,2,6),(13,3,1,3),(14,3,3,5),(15,3,3,6),(16,4,1,1),(17,4,2,2),(18,4,2,4),(19,4,3,3),(20,5,1,5),(21,5,2,5),(22,5,3,5),(23,6,1,1),(24,6,2,2),(25,6,3,3),(26,8,1,4),(27,8,1,6),(28,9,1,1),(29,9,1,2),(31,9,1,3),(32,10,2,1),(33,11,1,3);
...
CREATE TABLE `users` (
  ...
  KEY `status_id_idx` (`status`),
  CONSTRAINT `userRole` FOREIGN KEY (`role`) REFERENCES `roles` (`id`),
  CONSTRAINT `userStatus` FOREIGN KEY (`status`) REFERENCES `status` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'1612510276536','widowi','wido.wicaksono55@gmail.com','asd12!',1,1),(2,'1612518030556','wiwiwi','wicak@mail.com','asd123!',2,1);
...
-- Dump completed on 2021-02-05 17:20:02
